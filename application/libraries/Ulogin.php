...
/** Список возможных провайдеров авторизации */
	public $nets=array('vkontakte'=>1,'facebook'=>2,'twitter'=>3,'google'=>4);
...
/** Вид виджета авторизации */
	...
	private $providers_default=array('vkontakte');
	private $fields_default=array('first_name','last_name','photo','email');
	private $type='large';
...
/** Информация, предоставленная провайдером авторизации */
	...
	private $url='http://timequest/index.php/users';
...
<div id="uLogin" data-ulogin="display=panel;fields=first_name,last_name;providers=vkontakte,facebook,google,twitter;hidden=;redirect_uri=http%3A%2F%2F"></div>
*/
	public function get_html() {
		...
		return
			...
			'&providers=vkontakte,facebook,google,twitter'.
			'&hidden='.
